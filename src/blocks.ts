...
export default (editor: Editor, opts: RequiredPluginOptions) => {
  ...
  addBlock('mj-4-columns', {
    label: getI18nLabel('fourColumn'),
    media: `<svg viewBox="0 0 23 24">
      <path fill="currentColor" d="M2 20h4V4H2v16Zm-1 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1ZM17 20h4V4h-4v16Zm-1 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1ZM9.5 20h4V4h-4v16Zm-1 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1Z"/>
    </svg>`,
    content: `<mj-section>
  ...
  addBlock('mj-accordion-element', {
    label: getI18nLabel('accordionElement'),
    media: `<svg viewBox="0 0 24 24">
        <path fill="currentColor" d="M12,17.56L16.07,16.43L16.62,10.33H9.38L9.2,8.3H16.8L17,6.31H7L7.56,12.32H14.45L14.22,14.9L12,15.5L9.78,14.9L9.64,13.24H7.64L7.93,16.43L12,17.56M4.07,3H19.93L18.5,19.2L12,21L5.5,19.2L4.07,3Z" />
    </svg>`,
  ...
  addBlock('mj-carousel', {
    ...
    content: `<mj-carousel>
                <mj-carousel-image src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Bloem_geranium_pratense_%27Galactic%27._30-05-2024_%28d.j.b.%29.jpg/1280px-Bloem_geranium_pratense_%27Galactic%27._30-05-2024_%28d.j.b.%29.jpg"></mj-carousel-image>
                <mj-carousel-image src="https://upload.wikimedia.org/wikipedia/commons/5/53/Shadow_2752.jpg"></mj-carousel-image>
              </mj-carousel>`,
    activate: true
  });
